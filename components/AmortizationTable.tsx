        ...
        <table className="min-w-full divide-y divide-slate-200">
          <thead className="bg-slate-50">
            <tr>
              ...
              <th scope="col" className="px-4 py-3 text-right text-xs font-medium text-slate-500 uppercase tracking-wider">年供款總額</th>
          ...
          <tbody className="bg-white divide-y divide-slate-200">
            {yearlyData.map((row) => {
                ...
                let avgRate, avgMonthly, interest, principal, total, balance, color;
                ...
                return (
                  <tr key={row.year} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-right text-slate-900">{formatCurrency(total)}</td>
