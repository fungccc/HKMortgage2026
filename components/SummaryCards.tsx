    ...
    <div className="grid grid-cols-1 gap-4 mb-8">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
         <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className={`relative ${isHPlanCheaper ? '' : 'opacity-75'}`}>
                {isHPlanCheaper && (
                    <div className="absolute -top-3 left-0 bg-indigo-100 text-indigo-800 text-xs font-bold px-2 py-1 rounded">較低息方案</div>
                )}
      ...
      {result.refinance.enabled && result.refinance.totalNetGain > 0 && (
         <div className="bg-emerald-50 border border-emerald-100 p-5 rounded-xl">
            ...
            <div className="h-48 w-full mt-4 bg-white/60 rounded-lg p-2 border border-emerald-100/50 flex flex-col">
                ...
                <div className="text-center text-[10px] text-emerald-600/60 mt-1 font-medium flex-none">累積淨收益走勢 (年)</div>
            </div>
                    ...
                    <table className="w-full text-xs">
                        <thead className="bg-emerald-100/50 text-emerald-800 font-semibold border-b border-emerald-100">
                            <tr>
                                ...
                                <th className="py-2 px-3 text-right">當期淨賺</th>
                            </tr>
                        </thead>
        ...
        <div className="bg-blue-50 border border-blue-100 p-5 rounded-xl">
            ...
            <div className="space-y-3 bg-white p-3 rounded-lg border border-blue-100 shadow-sm">
                <div className="flex justify-between items-center text-sm">
                    <span className="text-slate-500">最低月入要求 (50% DSR)</span>
